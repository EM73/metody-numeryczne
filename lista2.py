...
a = get_int("First circles radius: ")
b = get_int("Second circles radius: ")
print(10*"*")
print(f"Perimeter of first circle is: {2*pi*a} ")
print(f"Field of first circle in is: {pi*(a**2)} ")
print()
print(f"Perimeter of second circle is {2*pi*b} ")
print(f"Field of first second is {pi*(b**2)} ")
print(10*"*")
...
print(f"Perimeter of first circle in round is {round(2*pi*a), 2}")
print(f"Field of first circle in round is {round(pi*(a**2), 2)}")
print()
print(f"Perimeter of second circle in round is {round(2*pi*b,2)}")
print(f"Field of first second circle in round is {round(pi*(b**2),2)}")
print(10*"*")
